...
On the TV, launch `PawCast`. From a phone or computer on the same LAN, open the `Open on phone` URL shown on the TV. Paste this APK URL into the `Paste APK URL` field:
